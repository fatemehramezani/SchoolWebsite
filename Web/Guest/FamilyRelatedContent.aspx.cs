...
public partial class Guest_FamilyRelatedContent : System.Web.UI.Page
{
    ...
    private void SetRelatedContent()
    {
        ...
        {
            category += string.Format(@"<li><a href=""FamilyRelatedContent.aspx?Id={0}"">{1}</a></li>",
                   relatedContent.Id,
            ...
            if (selectedRelatedContent != null)
            {
                relatedContentContent.InnerHtml = string.Format(@"
                   <div class=""product-info"">
                    ...
                    <div id=""tabs"" class=""htabs"" style=""direction: ltr;"">
