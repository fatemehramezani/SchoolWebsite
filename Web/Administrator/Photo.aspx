<%@ Page Title="" Language="C#" MasterPageFile="~/App_MasterPage/PanelMasterPage.master" AutoEventWireup="true" CodeFile="Photo.aspx.cs" Inherits="Administrator_Photo" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
   ...
   <asp:MultiView runat="server" ID="PhotoMultiView" ActiveViewIndex="0">
    ...
    <asp:GridView ID="PhotoGridView" runat="server" AutoGenerateColumns="False"  
                DataKeyNames="Id" DataSourceID="PhotoEntityDataSource" HorizontalAlign="Center"
                PageSize="5" Width="90%" AllowSorting="True" AllowPaging="True" OnSelectedIndexChanged="PhotoGridView_SelectedIndexChanged"  >
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                    ...
                    <asp:BoundField DataField="Title" HeaderText="عنوان" >
                     ...
                     <asp:TemplateField HeaderText="تاریخ">
                      ...
                      <asp:TemplateField HeaderText="اضافه کردن تصویر">
                        <ItemTemplate>
                             <asp:ImageButton ID="PhotoFilesImageButton" runat="server" OnClick="PhotoFilesImageButton_Click"  AlternateText='<%# Bind("Id") %>' ImageUrl="~/App_Themes/Panel/images/new-btn.png" />
                        </ItemTemplate>
                    </asp:TemplateField>
     ...
     <asp:View ID="EditView" runat="server">
            <asp:FormView ID="PhotoFormView" runat="server"  Width="90%" DataSourceID="PhotoEntityDataSource"
                DataKeyNames="Id" DefaultMode="Insert" OnItemDeleted="PhotoFormView_ItemDeleted"
                OnItemCommand="PhotoFormView_ItemCommand">
                <EditItemTemplate>
                    <asp:Label ID="Label1" runat="server" Text="عنوان:" SkinID="Caption" CssClass="lable"></asp:Label>
                  ...
                  <InsertItemTemplate>
                    <asp:Label ID="Label2" runat="server" Text="عنوان:" SkinID="Caption" CssClass="lable"></asp:Label>
                    <asp:TextBox ID="TitleTextBox" runat="server" Text='<%# Bind("Title") %>' MaxLength="500" />
